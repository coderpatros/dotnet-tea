...
internal static class SearchReleasesCommand
{
    public static Command Create(GlobalOptions globals)
    {
        ...
        var command = new Command("search-releases") { Description = "Search for product releases" };
        ...
        command.SetAction(async (parseResult, ct) =>
        {
            ...
            var result = await client.QueryProductReleasesAsync(
