...
public class SearchModel : PageModel
{
    ...
    public PaginatedResponse<TeaProductRelease>? Results { get; set; }
    ...
    public async Task OnGetAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            Results = await client.QueryProductReleasesAsync(idType, IdValue, PageOffset, PageSize ?? 20, cancellationToken);
        }
